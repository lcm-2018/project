...
$id_modulo = isset($_POST['modulo']) ? $_POST['modulo'] : exit('Acción no permitida');
...
try {
    ...
    $sql = "SELECT
            ...
            LEFT JOIN 
                ...
                FROM
                    `seg_rol_usuario`
                WHERE (`id_usuario` = $id_user)) AS `t1`
...
<div class="px-0">
    <div class="shadow mb-3">
        ...
        <div class="p-3">
            ...
            <input type="hidden" id="id_user_permisos" value="<?php echo $id_user ?>">
            <table id="tableOpcionesModulo" class="table-striped table-bordered table-sm nowrap" style="width:100%">
                <thead>
                    <tr>
